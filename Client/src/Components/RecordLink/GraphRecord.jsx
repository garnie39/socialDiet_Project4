...
function GraphRecord() {
  ...
  const newArray = getUserRecord
    .map((item) => ({ date: new Date(item.date), weight: item.weight }))
    .slice()
      ...
      <div className="graph-container" style={mainDiv}>
        ...
        <div style={btnStyle}>
          <Button
            ...
            variant="warning"
            onClick={() => handleTimePeriodBtn(oneWeekArray)}
          >
            {" "}
            1 week{" "}
          </Button>
          <Button
            style={{ color: "white", backgroundColor: "rgb(255, 132, 50)" }}
            variant="warning"
            onClick={() => handleTimePeriodBtn(oneMonthArray)}
          >
            {" "}
            1 month
          </Button>
          <Button
            ...
            variant="warning"
            color="warning"
            onClick={() => handleTimePeriodBtn(threeMonthsArray)}
          >
            {" "}
            3 months{" "}
          </Button>
          <Button
            style={{ color: "white", backgroundColor: "rgb(255, 132, 50)" }}
            variant="warning"
            onClick={() => handleTimePeriodBtn(sixMonthsArray)}
          >
            {" "}
            6 months{" "}
          </Button>
